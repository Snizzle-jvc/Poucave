...
$(function(a) {
  ...
  var e = window.location.href, k = JSON.parse(localStorage.getItem("Topic")) || [], l = JSON.parse(localStorage.getItem("Message")) || [], f = localStorage.getItem("Alias"), c = localStorage.getItem("Moderation");
  ...
  a("#poucave-clear").click(function() {
    if ("0" !== localStorage.getItem("Topic") || "0" !== localStorage.getItem("Message")) {
      1 == confirm("Vider la liste de signalements ?") && (localStorage.setItem("Topic", "0"), localStorage.setItem("Message", "0"), a("#topiccount").html("0"), a("#msgcount").html("0"));
    } else {
